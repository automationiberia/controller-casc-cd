...
[source,bash]
----
ansible-vault encrypt --vault-id dev group_vars/dev/configure_connection_controller_credentials.yml group_vars/pro/configure_connection_controller_credentials.yml
----
...
[source,bash]
----
ansible-vault encrypt --vault-id pro orgs_vars/${ORGNAME}/env/pro/controller_credentials.d/* orgs_vars/${ORGNAME}/env/dev/controller_credentials.d/*
----
...
[source,bash]
----
ansible-navigator run casc_ctrl_config.yml -i inventory -l dev -e "{orgs: '${ORGNAME}', dir_orgs_vars: orgs_vars, env: dev}" -m stdout --eei quay.io/automationiberia/aap/ee-casc --vault-id dev@.vault_password_dev --vault-id pro@.vault_password_pro
----

[.console-input]
[source,bash]
----
ansible-navigator run casc_ctrl_config.yml -i inventory -l pro -e "{orgs: '${ORGNAME}', dir_orgs_vars: orgs_vars, env: pro}" -m stdout --eei quay.io/automationiberia/aap/ee-casc --vault-id dev@.vault_password_dev --vault-id pro@.vault_password_pro
----
