...
5. Create a Merge Request to `dev` branch
   ...
   * Go to Merge Requests and create a new merge request image::mrtodev.png[New merge request] image:mrtodev.png[New merge request] ![New merge request](images/mrtodev.png "New merge request")
