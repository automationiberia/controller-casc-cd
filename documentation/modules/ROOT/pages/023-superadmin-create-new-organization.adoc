...
----
ansible-playbook new_project.yml -e "{organization_name: {neworg}, organization_desc: '{neworg} Organization', instance_groups: [MADRID], admin_user: 'neworgadminuser', orgs_vars: 'orgs_vars', orgs: '$\{SUPERADMIN_ORG\}', env: dev, casc_gitlab_scm_branch: dev} -e@gitlab.credentials.yaml"
----
+
.See the output
[%collapsible]
