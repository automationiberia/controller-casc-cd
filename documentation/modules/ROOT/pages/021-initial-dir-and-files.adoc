...
[source,bash]
----
cat > orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_instance_groups.d/controller_instance_groups.yml <<EOF
include::../examples/orgs_vars/superadmin/env/dev/controller_instance_groups.d/controller_instance_groups.yml[]
EOF
----
