...
[source,bash]
----
export CONTROLLER_DEV_HOST=lb-ctrl-dev.lab.example.com
export CONTROLLER_PRO_HOST=lb-ctrl-pro.lab.example.com
----
...
[source,console]
----
mkdir -p orgs_vars/${SUPERADMIN_ORG}/env/{dev,pro}/controller_{instance_groups.d,hosts.d/aap-casc,users.d,execution_environments.d/app-casc,settings.d/jobs,settings.d/user_interface,settings.d/authentication,settings.d/system,inventory_sources.d,credentials.d}
touch orgs_vars/${SUPERADMIN_ORG}/env/{dev,pro}/controller_{instance_groups.d,hosts.d/aap-casc,users.d,execution_environments.d/app-casc,settings.d/jobs,settings.d/user_interface,settings.d/authentication,settings.d/system,inventory_sources.d,credentials.d}/.gitkeep
----

[.console-input]
[source,console]
----
mkdir -p orgs_vars/${SUPERADMIN_ORG}/env/common/controller_{schedules.d/app-casc,workflow_job_templates.d/app-casc,job_templates.d/app-casc,job_templates.d/app-gitlab,projects.d/app-casc,projects.d/app-gitlab,teams.d,credential_types.d/aap-casc,roles.d,inventories.d/app-casc,organizations.d/app-casc,credentials.d}
touch orgs_vars/${SUPERADMIN_ORG}/env/common/controller_{schedules.d/app-casc,workflow_job_templates.d/app-casc,job_templates.d/app-casc,job_templates.d/app-gitlab,projects.d/app-casc,projects.d/app-gitlab,teams.d,credential_types.d/aap-casc,roles.d,inventories.d/app-casc,organizations.d/app-casc,credentials.d}/.gitkeep
----
======
...
[source,bash]
----
export AUTOMATIONHUB_HOST=lb-hub-dev-site.lab.example.com
----
...
[source,bash]
----
cat > orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_hosts.d/aap-casc/controller_hosts.yml <<EOF
include::../examples/orgs_vars/superadmin/env/dev/controller_hosts.d/aap-casc/controller_hosts.yml[]
EOF
----
...
[source,bash]
----
cat > orgs_vars/${SUPERADMIN_ORG}/env/common/controller_credential_types.d/aap-casc/controller_credential_types_gitlab_api.yml <<EOF
include::../examples/orgs_vars/superadmin/env/common/controller_credential_types.d/aap-casc/controller_credential_types_gitlab_api.yml[]
EOF
----
...
[source,bash]
----
export PROJECT_URL_CASC='<superadmin_git_url>'
----
...
[source,bash]
----
export PROJECT_URL_CASC_SETUP='<casc_setup_git_url>'
----
