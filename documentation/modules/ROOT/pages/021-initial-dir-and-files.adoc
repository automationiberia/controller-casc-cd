...
+
IMPORTANT: When creating the new repository, be sure to uncheck the `Initialize repository with a README` checkbox.
+
[NOTE]
=======
...
5. To test that the GitLab Runner is working properly, launch a test pipeline (optional):
+
