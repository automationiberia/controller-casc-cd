...
An *empty GitLab repository* is required to follow this workshop (you are supposed to provide this on your own gitlab account). Additionally, set-up on your gitlab account a new token with `api` scope and configure a ssh key pair to access your account if you haven't already done it.
...
.Encrypt the files with sensitive data (dev)
[.console-input]
[source,console]
----
ansible-vault encrypt --vault-id dev \
  group_vars/dev/configure_connection_controller_credentials.yml
----

.Encrypt the files with sensitive data (pro)
[.console-input]
[source,console]
----
ansible-vault encrypt --vault-id pro \
...
[source,bash]
----
ansible-vault encrypt --vault-id dev orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_credentials.d/{controller_credentials_scm.yml,controller_credentials_gitlab_api_token.yml}
----
...
[source,bash]
----
ansible-vault encrypt --vault-id dev orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_credentials.d/controller_credentials_vault.yml
----
...
[source,bash]
----
ansible-vault encrypt --vault-id dev orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_credentials.d/controller_credentials_galaxy.yml
----
...
[source,bash]
----
ansible-vault encrypt --vault-id dev orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_credentials.d/controller_credentials_registry.yml
----
////
...
[source,bash]
----
ansible-vault encrypt --vault-id dev orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_users.d/controller_user_accounts.yml
----
...
[source,bash]
----
ansible-vault encrypt --vault-id pro orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_credentials.d/{controller_credentials_scm.yml,controller_credentials_gitlab_api_token.yml}
----
...
[source,bash]
----
ansible-vault encrypt --vault-id pro orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_credentials.d/controller_credentials_vault.yml
----
...
[source,bash]
----
ansible-vault encrypt --vault-id pro orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_credentials.d/controller_credentials_galaxy.yml
----
...
[source,bash]
----
ansible-vault encrypt --vault-id pro orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_credentials.d/controller_credentials_registry.yml
----
////
==== Execution Environments to be used by the Job Templates
...
[source,bash]
----
ansible-vault encrypt --vault-id pro orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_users.d/controller_user_accounts.yml
----
