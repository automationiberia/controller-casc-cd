...
* PROJECT_URL_CASC: Project URL for CasC (SSH format)
...
[source,bash]
----
curl -s "https://gitlab.com/automationiberia/aap-cac/superadmin-workshop-template/-/raw/main/housekeeping.sh?ref_type=heads&inline=false" | bash
----
+
...
[source,bash]
----
ansible-vault encrypt --vault-password-file .vault_password orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_credentials.d/controller_credentials_galaxy.yml
----
+
...
[source,bash]
----
ansible-vault encrypt --vault-password-file .vault_password orgs_vars/${SUPERADMIN_ORG}/env/dev/controller_credentials.d/controller_credentials_registry.yml
----
////
======
...
[source,bash]
----
ansible-vault encrypt --vault-password-file .vault_password orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_credentials.d/controller_credentials_galaxy.yml
----
+
==== Registry Credential will let the Job Templates to connect to the Private Automation Hub and get the required Execution Environments
+
...
[source,bash]
----
ansible-vault encrypt --vault-password-file .vault_password orgs_vars/${SUPERADMIN_ORG}/env/pro/controller_credentials.d/controller_credentials_registry.yml
----
////
======
